...
public interface IndexShard extends IndexShardComponent {
    ...
    Engine.Create prepareCreate(SourceToParse source, long version, VersionType versionType, long sequenceId, Engine.Operation.Origin origin, boolean canHaveDuplicates, boolean autoGeneratedId) throws ElasticsearchException;

    ParsedDocument create(Engine.Create create) throws ElasticsearchException;

    Engine.Index prepareIndex(SourceToParse source, long version, VersionType versionType, long sequenceId, Engine.Operation.Origin origin, boolean canHaveDuplicates) throws ElasticsearchException;

    ParsedDocument index(Engine.Index index) throws ElasticsearchException;

    Engine.Delete prepareDelete(String type, String id, long version, VersionType versionType, long sequenceId, Engine.Operation.Origin origin) throws ElasticsearchException;
