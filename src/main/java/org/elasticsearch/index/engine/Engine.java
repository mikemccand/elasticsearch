...
public interface Engine extends IndexShardComponent, CloseableComponent {
    ...
    static abstract class IndexingOperation implements Operation {
        ...
        public IndexingOperation(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, long sequenceId, Origin origin, long startTime, boolean canHaveDuplicates) {
        ...
        public IndexingOperation(DocumentMapper docMapper, Term uid, ParsedDocument doc) {
            this(docMapper, uid, doc, Versions.MATCH_ANY, VersionType.INTERNAL, -1, Origin.PRIMARY, System.nanoTime(), true);
        }
    ...
    static final class Create extends IndexingOperation {
        ...
        public Create(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, long sequenceId, Origin origin, long startTime, boolean canHaveDuplicates, boolean autoGeneratedId) {
            super(docMapper, uid, doc, version, versionType, sequenceId, origin, startTime, canHaveDuplicates);
        ...
        public Create(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime) {
            this(docMapper, uid, doc, version, versionType, -1, origin, startTime, true, false);
        }
    ...
    static final class Index extends IndexingOperation {
        ...
        public Index(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, long sequenceId, Origin origin, long startTime, boolean canHaveDuplicates) {
            super(docMapper, uid, doc, version, versionType, sequenceId, origin, startTime, canHaveDuplicates);
        }
        ...
        public Index(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime) {
            super(docMapper, uid, doc, version, versionType, -1, origin, startTime, true);
        }
